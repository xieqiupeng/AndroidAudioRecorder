...
public class PlayerStates {
    ...
    public synchronized boolean isReadyToPlay() {
        return playerState == com.twirling.process.player.PlayerStates.READY_TO_PLAY;
    }
    ...
    public synchronized boolean isPlaying() {
        return playerState == com.twirling.process.player.PlayerStates.PLAYING;
    }
    ...
    public synchronized boolean isStopped() {
        return playerState == com.twirling.process.player.PlayerStates.STOPPED;
    }
}
